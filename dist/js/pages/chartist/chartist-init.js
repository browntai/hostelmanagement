$(function () {
  ...
  if ($('.ct-bar-chart').length) {
    ...
    var barChartEl = $('.ct-bar-chart')[0];
    if (barChartEl) {
      new Chartist.Bar(barChartEl, data, options, responsiveOptions);
    }
  }
