<?php
    ...
    if(isset($_POST['submit'])){
        // Store in session for persistence in case of failure
        ...
        if($stmt->execute()){
            ...
            unset($_SESSION['post_data']); // Clear on success
    ...
    function getValue($field, $default = '') {
        return isset($_SESSION['post_data'][$field]) ? htmlentities($_SESSION['post_data'][$field]) : $default;
    }
    
    function isChecked($field, $value) {
        if(isset($_SESSION['post_data'][$field]) && is_array($_SESSION['post_data'][$field])){
            return in_array($value, $_SESSION['post_data'][$field]) ? 'checked' : '';
        }
        return '';
    }
?>
                        ...
                        <div class="col-12">
                            <div class="card shadow-sm border-0 mb-4">
                                <div class="card-header bg-gradient-brand py-3">
                                    <h5 class="mb-0 text-white font-weight-bold"><i data-feather="home" class="feather-sm mr-2 text-white"></i>Proprietor Credentials</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="hostel_name" class="form-control border-focus-primary" placeholder="e.g. Riverside Residences" value="<?php echo getValue('hostel_name'); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="text-dark font-weight-medium">Primary Contact No.</label>
                                                <input type="text" name="phone" class="form-control border-focus-primary" placeholder="Enter contact number" value="<?php echo getValue('phone'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="text-dark font-weight-medium">Official Email</label>
                                                <input type="email" name="email" class="form-control border-focus-primary" placeholder="e.g. info@riverside.com" value="<?php echo getValue('email'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="text-dark font-weight-medium">City / Area <span class="text-danger">*</span></label>
                                                <input type="text" name="city" class="form-control border-focus-primary" placeholder="e.g. Lowlands" value="<?php echo getValue('city'); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <div class="form-group">
                                                <label class="text-dark font-weight-medium">Physical Address <span class="text-danger">*</span></label>
                                                <input type="text" name="address" class="form-control border-focus-primary" placeholder="Detailed location description" value="<?php echo getValue('address'); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="text-dark font-weight-medium">County / Region</label>
                                                <input type="text" name="state" class="form-control border-focus-primary" placeholder="e.g. Nairobi" value="<?php echo getValue('state'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="text-dark font-weight-medium">Caretaker/Secondary Contact</label>
                                                <input type="text" name="postal_code" class="form-control border-focus-primary" placeholder="Secondary contact number" value="<?php echo getValue('postal_code'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="text-dark font-weight-medium">Property Description</label>
                                                <textarea name="description" class="form-control border-focus-primary" rows="4" placeholder="Highlight key features of your hostel..."><?php echo getValue('description'); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card shadow-sm border-0 mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <h6 class="text-brand small text-uppercase font-weight-bold mb-3">Community Identity</h6>
                                        <label class="text-muted small text-uppercase font-weight-bold mb-3 d-block">Upload High Quality Photos</label>
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="hostel_images">Choose files (Max 5MB each)</label>
                                        </div>
                                    </div>
                            ...
                            <div class="card shadow-sm border-0 mb-4">
                                ...
                                <div class="card-body">
                                    <?php foreach($hostel_types as $type): 
                                        $typeChecked = isChecked('hostel_types', $type->id);
                                        $typeCount = getValue('type_count_' . $type->id);
                                        $typePrice = getValue('type_price_' . $type->id);
                                    ?>
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            <div class="custom-control custom-checkbox amenity-item p-2 rounded">
                                                <input type="checkbox" class="custom-control-input" id="amenity_<?php echo $amenity->id; ?>" 
                                                       ...
                                                       <?php echo isChecked('amenities', $amenity->id); ?>>
                            ...
                            <div class="card bg-light border-0">
                                <div class="card-body text-center py-4">
                                    <button type="submit" name="submit" class="btn btn-brand px-5 py-2 rounded-pill shadow-sm font-weight-bold mr-2">
                                        <i data-feather="check" class="feather-sm mr-2"></i> Submit Registration
                                    </button>
                                    <button type="reset" class="btn btn-outline-danger px-4 py-2 rounded-pill font-weight-bold mx-2">
                                        <i data-feather="rotate-ccw" class="feather-sm mr-2"></i> Reset Form
                                    </button>
