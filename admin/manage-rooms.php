                                ...
                                <tbody>
                                    <?php	
                                        ...
                                        $ret="SELECT rooms.*, tenants.name as tenant_name, hostels.name as hostel_name,
                                              (SELECT CONCAT(firstName, ' ', lastName) FROM bookings WHERE bookings.roomno = rooms.room_no AND bookings.tenant_id = rooms.tenant_id AND bookings.booking_status = 'confirmed' LIMIT 1) as booked_by
                                              FROM rooms 
                                        ...
                                        <td>
                                            <?php if($row->booked_by): ?>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <small class="text-dark font-weight-medium"><?php echo htmlentities($row->booked_by); ?></small>
                                                </div>
                                            <?php else: ?>
