            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-md-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">System Activity Logs</h4>
                    ...
                    <div class="col-12">
                        <div class="customize-input">
                            <div class="input-group">
                                ...
                                <input class="form-control border-0 shadow-sm" type="search" id="logSearch" placeholder="Search logs by email, action, or details..." aria-label="Search">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card shadow-sm border-0">
                            <div class="card-body">
                                <h6 class="card-subtitle mb-4">Showing recent system activities across the platform.</h6>
                                    ...
                                    <table class="table table-hover no-wrap custom-table" id="logsTable">
                                        <thead class="bg-light">
                                            <tr class="text-muted font-weight-bold">
                                                ...
                                                <th class="border-0">Metadata</th>
                                                <th class="border-0">Timestamp</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $ret = "SELECT * FROM user_activity_logs ORDER BY created_at DESC LIMIT 500";
                                            ...
                                            <?php
                                                ...
                                                while ($row = $res->fetch_object()) {
                                                    $roleBadge = 'light-info';
                                                    if($row->role == 'Admin') $roleBadge = 'light-danger';
                                                    if($row->role == 'Landlord') $roleBadge = 'light-primary';
                                                    if($row->role == 'Client') $roleBadge = 'light-success';
                                            ?>
                                            <tr class="log-row" data-search="<?php echo strtolower($row->user_email . ' ' . $row->action . ' ' . $row->details); ?>">
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="mr-2">
                                                            <h6 class="text-dark font-weight-medium mb-0"><?php echo htmlentities($row->user_email); ?></h6>
                                                            <span class="badge badge-<?php echo $roleBadge; ?> small"><?php echo htmlentities($row->role); ?></span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="text-muted small d-inline-block text-truncate" style="max-width: 300px;" title="<?php echo htmlentities($row->details); ?>">
                                                        <?php echo htmlentities($row->details); ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <small class="text-muted d-block"><i data-feather="layers" class="feather-xs mr-1"></i>IP: <?php echo htmlentities($row->ip_address); ?></small>
                                                    <small class="text-muted"><i data-feather="hash" class="feather-xs mr-1"></i>ID: <?php echo $row->id; ?></small>
                                                </td>
                                                <td>
