<?php
    ...
    if(isset($_POST['submit'])){
        ...
        // Update basic info (if super admin, don't filter by tenant_id)
        if ($tm->isSuperAdmin()) {
            $query = "UPDATE hostels SET name=?, description=?, address=?, city=?, state=?, postal_code=?, phone=?, email=? WHERE id=?";
            $stmt = $mysqli->prepare($query);
            $stmt->bind_param('ssssssssi', $hostel_name, $description, $address, $city, $state, $postal_code, $phone, $email, $hostel_id);
        } else {
                    ...
                    if($available_count > 0 && $price > 0){
                        ...
                        if($available_count > $existing_count) {
                            ...
                            for($i = $existing_count + 1; $i <= $available_count; $i++) {
                                ...
                                // Use the hostel's actual tenant_id for rooms, especially important for super admins
                                $hostelTenantId = $hostel->tenant_id;
                                $roomQuery = "INSERT INTO rooms (hostel_id, room_type_id, seater, room_no, fees, tenant_id) VALUES (?, ?, ?, ?, ?, ?)";
                                $roomStmt = $mysqli->prepare($roomQuery);
                                $roomStmt->bind_param('iiiidi', $hostel_id, $type_id, $seater, $temp_room_no, $price, $hostelTenantId);
                                $roomStmt->execute();
                                $roomStmt->close();
                            }
                        }
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="hostel_name" class="form-control" value="<?php echo htmlentities($hostel->name); ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" class="form-control" value="<?php echo htmlentities($hostel->phone); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" name="email" class="form-control" value="<?php echo htmlentities($hostel->email); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="city" class="form-control" value="<?php echo htmlentities($hostel->city); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" class="form-control" value="<?php echo htmlentities($hostel->address); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="state" class="form-control" value="<?php echo htmlentities($hostel->state); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="postal_code" class="form-control" value="<?php echo htmlentities($hostel->postal_code); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" rows="4"><?php echo htmlentities($hostel->description); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="existing-images">
                                        <h5 class="card-subtitle mb-2">Current Images</h5>
                                    ...
                                    <h5 class="card-subtitle mt-3">Add More Images</h5>
                                    <div class="form-group">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php foreach($all_hostel_types as $type): 
                                        $isChecked = isset($type_map[$type->id]);
                                        $count = $isChecked ? $type_map[$type->id]->available_count : '';
                                        $price = $isChecked ? $type_map[$type->id]->price_per_month : '';
                                    ?>
                                    <div class="type-pricing-row">
                                        ...
                                        <div style="flex: 1; display: flex; gap: 10px;">
                                            <input type="number" name="type_count_<?php echo $type->id; ?>" id="count_<?php echo $type->id; ?>" 
                                                   class="form-control" placeholder="Available Count" min="0" 
                                                   value="<?php echo $count; ?>"
                                                   <?php echo $isChecked ? 'required' : 'disabled'; ?>>
                                            <input type="number" name="type_price_<?php echo $type->id; ?>" id="price_<?php echo $type->id; ?>" 
                                                   class="form-control" placeholder="Price/Month (KSh)" step="0.01" min="0" 
                        ...
                        <div class="col-12">
                            <div class="form-actions">
                                <div class="text-center">
                                    <button type="submit" name="submit" class="btn btn-info">Update Hostel</button>
