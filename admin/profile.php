            ...
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        // Fallback/Debug: If not found in users, check admin table
                        if($res->num_rows == 0) {
                        ...
                        <div class="col-lg-4 col-md-5">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center">
                                    <h5 class="card-title mb-4">Profile Avatar</h5>
                                    <div class="mb-4">
                                        <?php 
                                        $pic = $row->profile_pic ? "../uploads/profiles/" . $row->profile_pic : "../assets/images/users/admin-icn.png";
                                        ?>
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <span class="badge badge-success position-absolute" style="bottom: 10px; right: 10px; border: 2px solid #fff; border-radius: 50%; width: 20px; height: 20px;"> </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="custom-file mt-2">
                                        ...
                                        <label class="custom-file-label text-left" for="profile_pic">Change photo...</label>
                        ...
                        <div class="col-lg-8 col-md-7">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-header bg-gradient-primary py-3">
                                    <h5 class="mb-0 text-white"><i data-feather="settings" class="feather-sm mr-2"></i>Account Information</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <label class="text-muted font-weight-medium small text-uppercase mb-2 d-block"><i data-feather="calendar" class="feather-xs mr-1 text-primary"></i> Member Since</label>
                                            <input type="text" class="form-control bg-light border-0" value="<?php echo date('M d, Y', strtotime($row->created_at)); ?>" disabled>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label class="text-muted font-weight-medium small text-uppercase mb-2 d-block"><i data-feather="shield" class="feather-xs mr-1 text-primary"></i> Access Level</label>
                                            <span class="badge badge-light-primary text-primary px-3 py-2 d-block text-left" style="font-size: 0.9rem;">
                                                Full System Access
                                            </span>
                                        </div>
                                    </div>

                                    <div class="alert alert-info border-0 shadow-none mb-0 mt-2">
                                        <div class="d-flex align-items-start">
                                            <i data-feather="info" class="text-info mr-2 mt-1 feather-sm"></i>
                                            <p class="mb-0 small text-info">You cannot make changes to your full name or registration date. For security reasons, please contact the main administrator for these updates.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 pt-3 border-top text-right">
                                        ...
                                        <button type="reset" class="btn btn-outline-danger px-4 ml-2">Reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
