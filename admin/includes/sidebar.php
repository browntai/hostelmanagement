...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item" style="background-color: #ffcccc;"> 
            <a class="sidebar-link sidebar-link" href="super_impersonate.php?action=stop" aria-expanded="false">
        ...
        class="hide-menu">View Client Acc.</span></a></li>
        <?php endif; ?>
        ...
        class="hide-menu">Booking Requests</span><span class="badge badge-danger rounded-circle ml-auto" id="sidebar-bookings-count" style="display:none;">0</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="../landlord/maintenance-requests.php"
