...
<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="super_dashboard.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="manage-tenants.php" aria-expanded="false">
                <i data-feather="grid" class="feather-icon"></i>
                <span class="hide-menu">Landlords</span>
            </a>
        </li>
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="manage-approvals.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="manage-hostels.php" aria-expanded="false">
                <i data-feather="database" class="feather-icon"></i>
                <span class="hide-menu">All Hostels</span>
            </a>
        </li>
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="manage-rooms.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="bookings.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="manage-clients.php" aria-expanded="false">
                <i data-feather="users" class="feather-icon"></i>
                <span class="hide-menu">All Bookings</span>
            </a>
        </li>
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="view-clients-acc.php" aria-expanded="false">
                <i data-feather="user" class="feather-icon"></i>
                <span class="hide-menu">View Client Accounts</span>
            </a>
        </li>
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="add-user.php" aria-expanded="false">
                <i data-feather="user-plus" class="feather-icon"></i>
                <span class="hide-menu">Add User</span>
            </a>
        </li>
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="manage-users.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="payments.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="messages.php" aria-expanded="false" onclick="suppressBadge('#sidebar-messages-count-super');">
                <i data-feather="message-square" class="feather-icon"></i>
                <span class="hide-menu">Messages <span class="badge badge-pill badge-primary float-right" id="sidebar-messages-count-super" <?php if($unread_msg_count==0) echo 'style="display:none;"'; ?>><?php echo $unread_msg_count; ?></span></span>
            </a>
        </li>
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="all-notifications.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="activity-logs.php" aria-expanded="false">
        ...
        <li class="sidebar-item"> 
            <a class="sidebar-link sidebar-link" href="acc-setting.php" aria-expanded="false">
