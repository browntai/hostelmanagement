<nav class="navbar top-navbar navbar-expand-md">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        <!-- Logo icon -->
                        <?php
                            $dashLink = ($_SESSION['role'] == 'admin') ? 'super_dashboard.php' : 'dashboard.php';
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-danger btn-sm text-white mt-3 mr-2" href="super_impersonate.php?action=stop" style="line-height: 1;">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                    <?php	
                                    $aid=$_SESSION['id'];
                                        $ret="SELECT full_name, email, profile_pic from users where id=?";
                                        ...
                                        {
                                            $userPic = $row->profile_pic ? "../uploads/profiles/" . $row->profile_pic : "../assets/images/users/admin-icn.png";
                                            // Update the img tag above via JS or direct echo if possible, but here we are inside the toggle.
                                            // Actually, the img tag is before this PHP block. Let's start the PHP block earlier.
                                            ?>
                                <img src="<?php echo $userPic; ?>" alt="user" class="rounded-circle" width="35" height="35" style="object-fit: cover;">
